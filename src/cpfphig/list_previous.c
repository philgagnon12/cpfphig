                                     ...
                                     CPFPHIG_OPTIONAL struct cpfphig_error* Error )
{
    ...
    {
        if( Error != NULL )
            cpfphig_error_message(cpfphig_system_error, "List_Iterator or Item is NULL", Error );
    ...
    {
        if( Error != NULL )
            cpfphig_error_message(cpfphig_system_error, "List_Iterator->list is NULL", Error );
    ...
    {
        if( Error != NULL )
            cpfphig_error_message(cpfphig_user_error, "End of list has been reached", Error );
    ...
    {
            if( Error != NULL )
                cpfphig_error_message(cpfphig_system_error, "current_node->item is NULL", Error );
