                  ...
                  CPFPHIG_OPTIONAL struct cpfphig_error*   Error )
{
    ...
    {
        if( Error != NULL )
            cpfphig_error_message(cpfphig_system_error, "pthread_mutexattr_init failed", Error, __FILE__, __FUNCTION__, __LINE__ );
                                            ...
                                            Error ) ) )
    {
        ...
        {
            if( Error != NULL )
                cpfphig_error_message(cpfphig_system_error, "pthread_mutex_init failed", Error, __FILE__, __FUNCTION__, __LINE__ );
    ...
    if( 0 != pthread_mutexattr_destroy( &(Mutex_Attr->pthread_mutex_attr) ) )
    {
        ...
        {
            if( Error != NULL )
                cpfphig_error_message(cpfphig_system_error, "pthread_mutexattr_destroy failed", Error, __FILE__, __FUNCTION__, __LINE__ );
