                        ...
                        CPFPHIG_OPTIONAL struct cpfphig_error*    Error )
{
    ...
    {
        if( Error != NULL )
            cpfphig_error_message(cpfphig_system_error, "Cond or Cond_Attr is NULL", Error, __FILE__, __FUNCTION__, __LINE__ );
                                            ...
                                            Error ) ) )
    {
        ...
        {
            if( Error != NULL )
                cpfphig_error_message(cpfphig_system_error, "pthread_cond_init failed", Error, __FILE__, __FUNCTION__, __LINE__ );
