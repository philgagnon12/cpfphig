...
fphig
fphig_thread_cond_attr_destroy( struct fphig_thread_cond_attr*          Cond_Attr,
                                FPHIG_OPTIONAL struct fphig_error*    Error )
{
    ...
    {
        if( Error != NULL )
            fphig_error_message(fphig_system_error, "pthread_condattr_destroy failed", Error, __FILE__, __FUNCTION__, __LINE__ );
