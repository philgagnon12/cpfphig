...
mphig
mphig_thread_cond_attr_init( struct mphig_thread_cond_attr*          Cond_Attr,
                             MELPHIG_OPTIONAL struct mphig_error*    Error )
{
    ...
    {
        if( Error != NULL )
            mphig_error_message(mphig_system_error, "pthread_condattr_init failed", Error, __FILE__, __FUNCTION__, __LINE__ );
