...
#include "cpfphig/mock/list_mock.h"
...
static void arguments( void** state )
{
    ...
    expect_string( cpfphig_error_message, Message, "List_Iterator or Item is NULL");
    assert_int_equal( CPFPHIG_FAIL, real_cpfphig_list_next( NULL,
                                                          &item,
                                                          &error ) );
...
static void list_null( void** state )
{
    ...
    expect_value( cpfphig_error_message, Error_Type, cpfphig_system_error );
    expect_string( cpfphig_error_message, Message, "List_Iterator->list is NULL");
    assert_int_equal( CPFPHIG_FAIL, real_cpfphig_list_next( &list_iterator,
                                                          &item,
                                                          &error ) );
}
...
static void empty_list( void** state )
{
    ...
    expect_string( cpfphig_error_message, Message, "End of list has been reached");
    assert_int_equal( CPFPHIG_FAIL, real_cpfphig_list_next( &list_iterator,
                                                          &item,
                                                          &error ) );
}
...
static void next_item_is_null( void** state )
{
    ...
    expect_value( cpfphig_error_message, Error_Type, cpfphig_system_error );
    expect_string( cpfphig_error_message, Message, "current_node->item is NULL");
    assert_int_equal( CPFPHIG_FAIL, real_cpfphig_list_next( &list_iterator,
                                                          &item,
                                                          &error ) );
}
